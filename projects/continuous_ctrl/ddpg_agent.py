...
class DdpgAgent():
    ...
    def act(self, state, add_noise=True):
        ...
        # use next line if we want to constrain output to [0, 1]. Input coming from actor_local is already in [-1, 1].
